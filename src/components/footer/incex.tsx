  ...
  return (
    <footer className="bg-black text-white py-8 border-t border-gray-800">
      <div className="container mx-auto px-4">
        {/* Versão Mobile (centralizado) */}
        <div className="md:hidden text-center mb-6">
          <h2 className="text-xl font-bold">Meu Portfólio</h2>
        </div>
        
        {/* Versão Desktop/Notebook (alinhado com os ícones) */}
        <div className="hidden md:flex flex-col lg:flex-row justify-between items-center">
          <div className="mb-4 lg:mb-0">
            <h2 className="text-xl font-bold">Meu Portfólio</h2>
            <p className="text-gray-400 mt-2 hidden lg:block">Desenvolvedor de Software Full Stack</p>
          </div>
        ...
        {/* Rodapé inferior (comum a ambas versões) */}
